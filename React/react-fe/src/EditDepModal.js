            ...
            <div className="container">
                <Modal {...this.props} size="lg" aria-labelledby="contained-modal-title-vcenter" centered>
                    <Modal.Header closeButton>
                        <Modal.Title id="contained-modal-title-vcenter">Edit Departnent</Modal.Title>
                    </Modal.Header>
                            ...
                            <Col sm={6}>
                                <Form onSubmit={this.handleSubmit}>
                                    ...
                                    <Form.Group controlId="DepartmentName">
                                        ...
                                        <Form.Control type="text" name="DepartmentName" rewquired defaultValue={this.props.depname} placeholder="DepartmentName" />
                                    </Form.Group>
                                    <br />
